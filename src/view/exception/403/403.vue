...
<template>
  <div class="forbidden-page">
    <div
      class="forbidden-page__glow"
      aria-hidden="true" />
    <div class="forbidden-page__inner">
      <div class="forbidden-page__code-wrap">
        <span
          class="forbidden-page__code"
          aria-hidden="true"
          >403</span
        >
        <span
          class="forbidden-page__code-shadow"
          aria-hidden="true"
          >403</span
        >
      </div>
      <h1 class="forbidden-page__title">{{ t('exception.forbiddenHeading') }}</h1>
      <p class="forbidden-page__desc">
        {{ t('exception.forbiddenDesc') }}
      </p>
...
.forbidden-page__code-wrap {
  position: relative;
  display: inline-block;
  margin-bottom: clamp(0.75rem, 3vw, 1.5rem);
}

.forbidden-page__code-shadow {
  position: absolute;
  left: 0;
  top: 0;
  width: 100%;
...
@media (max-width: 480px) {
  ...
  .forbidden-page__actions :deep(.n-button) {
    width: 100%;
    max-width: 280px;
  }
}
